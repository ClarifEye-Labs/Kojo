...
class ViewClientsScreen extends Component {
  constructor(props){
    super(props)
    this.state = {
  ...
  getMainHeaderView = () => {
    ...
    return (
      <View style={expandedHeaderContainerStyle}>
        <Text style={headingStyle}>{strings.viewClients} </Text>
        <Text style={subHeadingStyle}>{strings.viewYourClientsBelow} </Text>
      </View>
    )
  }
  ...
  getCollapsedHeaderView = () => {
    ...
    return (
      <View style={collpasedHeaderContainer}>
        <Text style={collpasedHeaderTitle}>{strings.viewClients}</Text>
      </View>
    )
  }
...
ViewClientsScreen.navigationOptions = {
  header: null
}

ViewClientsScreen.propTypes = {
