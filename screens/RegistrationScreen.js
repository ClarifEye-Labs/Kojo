...
class RegistrationScreen extends React.Component {
  ...
  submitButtonOnClick = () => {
    ...
    errors.confirmPassword = this.performConfirmPasswordValidation(
      passwordEntered,
      confirmationPasswordEntered
    );
    ...
    this.setState(
      {
        ...
        passwordErrorStatus:
          errors.password.errorStatus || errors.confirmPassword.errorStatus,
  ...
  peformUIOperationsForShowingErrors(errors) {
    if (
      !errors.name.errorStatus &&
      !errors.email.errorStatus &&
      !errors.password.errorStatus &&
      !errors.confirmPassword.errorStatus
    ) {
  ...
  performRegistration() {
    const { emailEntered, passwordEntered } = this.state;
    ...
    this.setState(
      ...
      () => {
        Utils.dispatchScreen(
          screens.SupplierRestaurantScreen,
          undefined,
  ...
  writeUserToFireStore = async () => {
    ...
    await ref
      ...
      .catch((error) => {
        console.log("Error writing user to firestore", error);
      });
  };
  ...
  registrationFailure = (error) => {
    ...
    console.log("Registration failure called", error);
    alert(error);
  };
    ...
    const screen = (
      <View style={mainContainer}>
        ...
        <View style={termsContainer}>
          <Text style={termsStyle}>{strings.registeringWithKojoHeadline}</Text>
          <View style={tandcContainer}>
            <TouchableOpacity
              onPress={() =>
                navigation.navigate(screens.SupplierRestaurantScreen)
              }
            >
